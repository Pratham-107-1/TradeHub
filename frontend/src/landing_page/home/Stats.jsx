      ...
      <div className="row p-5">
        <div className="col-6 p-5 HomeTextBlocks">
          <h1 className='mb-5' style={{fontSize:"2.3rem",opacity:"0.85"}}>Trust with confidence</h1>
            ...
            <p>That's why 1.5+ crore customers trust TradeHub with ₹4.5+ lakh crores of equity investments and contribute to 15% of daily retail exchange volumes in India.</p>
         
          
            <h3>No spam or gimmicks</h3>
            <p>No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like.</p>
          
            <h3>The TradeHub universe</h3>
