      ...
      <div className="row Brokerage">
        ...
        <div className="col">
          ...
          <p>
            ...
            When trading at TradeHub, STT/CTT can be a lot more than the
          ...
          <p>
            ...
            dealer at TradeHub including auto square off orders.
          </p>
          <h5>Stamp charges</h5>
          <p>
        ...
        <div className="col">
          ...
          <p>
            ₹15.34 per scrip (₹3.5 CDSL fee + ₹9.5 TradeHub fee + ₹2.34 GST) is
