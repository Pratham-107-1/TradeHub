  ...
  return (
    <div className='container'>
      <div className="row p-5 mt-5 mb-5">
        <h1 className=' text-center' style={{opacity:"0.85",fontSize:"2.1rem",lineHeight:"2.8rem"}}>
        We pioneered the discount broking model in India. <br />
        Now, we are breaking ground with our technology.
        </h1>
      </div>
      <div className="row p-5 mt-5 border-top" style={{lineHeight:"1.8",fontSize:"1.05rem",opacity:"0.98",marginInline:"6rem"}} >
